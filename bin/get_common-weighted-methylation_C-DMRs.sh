...
echo "------" $SAMPLE " " $CHR
SAMPLEPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ac_merge_C-DMR/aa_data"
OUTPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ac_merge_C-DMR/bd_output"

#merge the contexts in one, sort, merge overlapping positions, get weigted methylation
cat $SAMPLEPATH/$SAMPLE*$CHR.methylation.bed | sort -k 1.4n -k 2n |awk '{OFS="\t"}{print $1,$2,$3,$4,$5}' |\
