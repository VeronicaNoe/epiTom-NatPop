#!/bin/bash
CHR="$( cat $1 )"
SAMPLE_DIR="05_DMR-processing/05.1_DMR-classification/05.0_get-DMR/aa_natural-accessions"
...
for FILE in ${SAMPLE_DIR}/$CHR*.CG-DMR.bed; do
    base_name=$(basename "$FILE" .bed)  # Corrected to use $FILE instead of $file
