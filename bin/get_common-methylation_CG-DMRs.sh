...
CG_LOCI_DIR="/mnt/disk2/vibanez/02_methylkit/aj_common/loci"
OUTPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ab_merge_CG-DMR/aa_data"
...
sortBed -i - |\
intersectBed -wb -a - -b $CG_LOCI_DIR/$CHR"_CG-DMR-loci_collapsed.bed" -nonamecheck |\
