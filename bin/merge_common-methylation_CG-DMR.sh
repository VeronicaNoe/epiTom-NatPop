...
echo "------" $CHR
SAMPLEPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ab_merge_CG-DMR/aa_data"
CHR_SIZE="/mnt/disk2/vibanez/02_methylkit/ab_preprocessing/ag_merge_CG-DMR/chr.size.bed"
OUTPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ab_merge_CG-DMR/bb_output"
SAMPLE="$( ls $SAMPLEPATH/*$TO_LIST*.methylation.bed | tr '\n' '\t' )"
KEEP="/mnt/disk2/vibanez/02_methylkit/aj_common/loci"
#echo $SAMPLE
...
#ls $SAMPLEPATH/*$TO_LIST*.methylation.bed | sed 's./mnt/disk2/vibanez/02_methylkit/aj_common/ab_merge_CG-DMR/aa_data/..g' |\
#sed 's/_Biseq_CG_ch01.methylation.bed//g' > $OUTPATH/00_colNames.tsv
