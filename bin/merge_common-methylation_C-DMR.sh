...
echo "------" $CHR
SAMPLEPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ac_merge_C-DMR/bd_output"
CHR_SIZE="/mnt/disk2/vibanez/02_methylkit/ab_preprocessing/ah_merge_C-DMR/chr.size.bed"
OUTPATH="/mnt/disk2/vibanez/02_methylkit/aj_common/ac_merge_C-DMR/bb_output"
...
intersectBed -a - -b $KEEP/$CHR"_C-DMR-loci_collapsed.bed" > $OUTPATH/$CHR"_C-DMR.merged.methylation.tmp"

ls $SAMPLEPATH/$CHR*.weighted.methylation.bed |\
sed 's./mnt/disk2/vibanez/02_methylkit/aj_common/ac_merge_C-DMR/bd_output/..g' |\
