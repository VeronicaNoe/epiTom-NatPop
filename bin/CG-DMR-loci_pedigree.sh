#!/bin/bash
OUT_DIR="05_DMR-processing/05.1_DMR-classification/05.1_get-collapsed-loci/ab_pedigree"
INDIR="05_DMR-processing/05.1_DMR-classification/05.0_get-DMR/ab_predigree"
