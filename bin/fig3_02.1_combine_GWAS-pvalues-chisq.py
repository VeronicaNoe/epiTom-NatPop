...
def main():
    ...
    input_dir = "/mnt/disk2/vibanez/10_data-analysis/Fig3/aa_GWAS-DMRs/bd_results/sig"
    output_dir = "/mnt/disk2/vibanez/10_data-analysis/Fig3/ab_data-analysis/results"
    ...
    with open(os.path.join(output_dir, f'02.1_combined_pvalues_{dmr_type}.csv'), 'w') as outfile:
